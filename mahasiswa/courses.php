        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden transform hover:-translate-y-2 transition-transform duration-300">
            ...
            <div class="px-6 pb-6">
                <?php if (is_null($row['id_pendaftaran'])): ?>
                    <a href="proses_pendaftaran.php?id=<?php echo $row['id']; ?>" class="block w-full text-center bg-gradient-to-r from-[#FF6B6B] to-[#FF947A] text-white font-semibold py-2 rounded-lg hover:opacity-90 transition-opacity">
                        Daftar Praktikum
                    </a>
                <?php else: ?>
