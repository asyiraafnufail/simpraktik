    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <?php if ($result->num_rows > 0):
            ...
            <div class="border rounded-lg p-4 flex flex-col justify-between shadow hover:shadow-lg transition-shadow">
                ...
                <a href="detail_praktikum.php?id=<?php echo $row['id']; ?>" class="mt-4 bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded text-center">
                    Lihat Detail & Tugas
                </a>
            </div>
            <?php endwhile;
        else: ?>
            <p class="col-span-3 text-gray-500">Anda belum mendaftar di praktikum manapun. Silakan <a href="courses.php" class="text-blue-600 hover:underline">cari praktikum</a>.</p>
        <?php endif; ?>
    </div>
</div>
